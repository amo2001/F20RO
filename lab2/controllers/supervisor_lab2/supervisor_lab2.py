...
class SupervisorLight:
    ...
    def run_seconds(self,seconds):
        ...
        while self.supervisor.step(self.time_step) != -1:
            ...
            if(stop == iterations):
                ...
                NEW_LIGHT_LOC = [1.3, 0.2, 0.2]
                self.location_field.setSFVec3f(NEW_LIGHT_LOC)
                # Change light direction
                NEW_LIGHT_DIR = [-1.2, -0.1, -0.5]
                self.direction_field.setSFVec3f(NEW_LIGHT_DIR)
    ...
    def run_demo(self):        
        ...
        INITIAL_LIGHT_LOC = [1.2, 1, 0.2]
        self.location_field.setSFVec3f(INITIAL_LIGHT_LOC)
        # Initial light location
        INITIAL_LIGHT_DIR = [-0.7, -0.7, -0.5]
        self.direction_field.setSFVec3f(INITIAL_LIGHT_DIR)
        self.light_node.resetPhysics()
